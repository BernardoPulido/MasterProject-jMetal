...
setwd("~/Documentos/GitHub/MasterProject-jMetal/jMetal/experiments/VehicleRoutingStudy/referenceFronts")

a <- read.table("VRP.pf")

#setwd("C:/Users/luis_/Documents/GitHub/MasterProject-jMetal/jMetal/results")
setwd("~/Documentos/GitHub/MasterProject-jMetal/jMetal/results")
...
legend(0.1, 0.06, legend = c("Población inicial", "Última población"), 
